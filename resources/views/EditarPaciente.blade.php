          ...
          <div class="row">
            ...
            <h3 class="login-heading mb-4">Editar Pacientes</h3>              
              <form action="{{route('Paciente.update',$Buscarpaciente->id)}}" method="POST">
                ...
                <div class="form-label-group">
                  <input type="text" name="nombreAcompanante"id="inputNombreAcomP" class="form-control" placeholder="Nombre del Acompañante" required autofocus value= "{{$Buscarpaciente->nombreAcompanante}}">
